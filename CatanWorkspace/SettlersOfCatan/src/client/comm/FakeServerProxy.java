...
/**
 * A faker server proxy facade for testing purposes. The data returned from this
 * proxy is all fake data that is hard-coded in.
 * 
 * @author Cory Beutler
 * 
 */
public class FakeServerProxy extends AbstractServerProxy {
	/**
	 * Log an existing user into the server This function will also set the
	 * cookie for the system
	 * 
	 * @param user
	...
	/**
	 * Register a new user with the server This function sets the cookie for the
	 * system
	 * 
	 * @param user
	 ...
	 * @param randomTiles
	 *            whether the game will have random tile position
	 * @param randomNumbers
	 *            whether the numbers of each hex will be random
	 * @param randomPorts
	...
	/**
	 * Fetch the list of commands that the server has executed for debug
	 * purposes
	 * 
	 ...
	 * 
	 * @param playerIndex
	 *            the index of the player sending the chat message
	 * @param content
	 ...
	 * 
	 * @param playerIndex
	 *            the player doing the robbing
	 * @param victimIndex
	 *            the player being robbed from
	 * @param location
	...
	+ " 		{                                                             "  
	+ " 		\"source\": \"Sam\",                                          "  
	+ " 		\"message\": \"Sam moved the robber and robbed Brooke.\"      "  
	+ " 		}                                                             "  
	+ " 		]                                                             "  
	+ " 		},                                                            "  
	+ " 		\"chat\": {                                                   "  
	...
	+ "		{                                                            " 
	+ "		\" source\" : \" Brooke\" ,                                  " 
	+ "		\" message\" : \" Brooke bought a Development Card.\"        " 
	+ "		}                                                            " 
	+ "		]                                                            " 
	+ "		},                                                           " 
	+ "		\" chat\" : {                                                " 
	...
	public CatanModel movesYearOfPlenty(int playerIndex,
		...
		+ "	{                                                                 "  
		+ "	\"source\": \"Sam\",                                              "  
		+ "	\"message\": \"Sam used Year of Plenty and got a brick and a ore\""  
		+ "	}                                                                 "  
		+ "	]                                                                 "  
		+ "	},                                                                "  
		+ "	\"chat\": {                                                       "  
	 ...
	 * 
	 * @param playerIndex
	 *            the index of the player building the road
	 * @param spot1
	 *            the location for a road being built
	 * @param spot2
	...
	public CatanModel movesSoldier(int playerIndex, int victimIndex,
		...
		String jsonResponse = ""
				...
				+ "	{                                                                     "   
				+ "	\"source\": \"Brooke\",                                               "   
				+ "	\"message\": \"Brooke used a soldier \"                               "   
				+ "	},                                                                    "   
				+ "	{                                                                     "   
				+ "	\"source\": \"Brooke\",                                               "   
				+ "	\"message\": \"Brooke moved the robber and robbed Brooke.\"           "   
				+ "	}                                                                     "   
				+ "	]                                                                     "   
				+ "	},                                                                    "   
				+ "	\"chat\": {                                                           "   
	 ...
	 * 
	 * @param playerIndex
	 *            the player playing the Monopoly card
	 * @param resource
	...
	public CatanModel movesMonopoly(int playerIndex, ResourceType resource)
		...
		+ "	{                                                                       " 
		+ "	\"source\": \"Sam\",                                                    " 
		+ "	\"message\": \"Sam stole everyones ore\"                                " 
		+ "	}                                                                       " 
		+ "	]                                                                       " 
		+ "	},                                                                      " 
		+ "	\"chat\": {                                                             " 
	...
	public CatanModel movesMonument(int playerIndex) throws IOException {
		...
		+ "	{                                                                      " 
		+ "	\"source\": \"Brooke\",                                                " 
		+ "	\"message\": \"Brooke built a monument and gained a victory point\"    " 
		+ "	}                                                                      " 
		+ "	]                                                                      " 
		+ "	},                                                                     " 
		+ "	\"chat\": {                                                            " 
	 ...
	 * @param location
	 *            the location the player is building the road
	 * @param free
	 ...
	 * @param location
	 *            the location of the city bing built
	 * @param free
	...
	public CatanModel movesBuildCity(int playerIndex, VertexLocation location,
		...
		+ "	{                                                                            " 
		+ "	\"source\": \"Brooke\",                                                      " 
		+ "	\"message\": \"Brooke upgraded to a city\"                                   " 
		+ "	}                                                                            " 
		+ "	]                                                                            " 
		+ "	},                                                                           " 
		+ "	\"chat\": {                                                                  " 
	 ...
	 * 
	 * @param playerIndex
	 *            the index of the player accepting the trade
	 * @param willAccept
	...
	/**                                                                                
	 * Pss a port trade for the given player with the given ratio and                  
	 * rrce types                                                                      
	 *                                                                                 
	 * @m playerIndex                                                                  
	 *         the player doing the maritime trade                                      
	 * @m ratio                                                                        
	 *            the ratio to trade the resources at
	 * @param inputResource
	 ...
	 * 
	 * @param playerIndex
	 *            the player discarding the card
	 * @param cards
