...
public class MovesBuildSettlementHandler extends SimpleHandler
{
	private static final Logger log = Logger.getLogger(MovesBuildSettlementHandler.class);
	...
	public void handle(HttpExchange exchange) throws IOException
	{
		try{
			...
			try
			{
				...
				BuildSettlementRequest request = getRequest(exchange, BuildSettlementRequest.class);
				
				ServerGame game = getGame(exchange, server);
				
				game.getMovesFacade().buildSettlement(request);
