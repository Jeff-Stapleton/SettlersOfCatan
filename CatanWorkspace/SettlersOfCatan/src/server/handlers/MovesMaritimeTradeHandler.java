...
public class MovesMaritimeTradeHandler extends SimpleHandler
{
	private static final Logger log = Logger.getLogger(MovesMaritimeTradeHandler.class);
	...
	public void handle(HttpExchange exchange) throws IOException
	{
		...
		try
		{
			...
			MaritimeTradeRequest request = getRequest(exchange, MaritimeTradeRequest.class);
			
			ServerGame game = getGame(exchange, server);
			
			game.getMovesFacade().maritimeTrade(request);
